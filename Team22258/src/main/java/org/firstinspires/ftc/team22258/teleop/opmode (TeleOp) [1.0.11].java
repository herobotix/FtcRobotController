...
/*
Removed Wrist as it is no longer part of the robot. Renamed F_ToggleArm with F_NewWriston. Added Armon to F_Startup.
*/

@TeleOp(name = "Opmode (TeleOp) [1.0.11]")
public class opmode__TeleOp___1_0_11_ extends LinearOpMode {
