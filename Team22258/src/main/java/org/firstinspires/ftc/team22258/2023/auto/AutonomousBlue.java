...
@Autonomous(name = "AutonomousBlue", group = "FINAL")
public class AutonomousBlue extends OpMode {
    ...
    private static final double MAX_LINVEL = 2200, MAX_LINACC = 2000;
    private static final double MAX_ANGVEL = 2200, MAX_ANGACC = 1500;
    //private static final double MAX_ANGVEL = 135, MAX_ANGACC = 60;
    private static final double MAX_LATVEL = 2200, MAX_LATACC = 1500;

    private static final boolean USE_WEBCAM = true;  // true for webcam, false for phone camera
    private static final String TFOD_MODEL_FILE = "/sdcard/FIRST/tflitemodels/model_blue.tflite";
    ...
    double DEGREES_TO_TICKS = INCHES_TO_TICKS * ipd * ANG_BIAS;
    ...
    public void init_loop() {
        ...
        telemetry.addData("Game Alliance:", "Blue");
    ...
    public void start() {
        ...
        if(Objects.equals(location, "OutField")) {
            if (spikeNum == 1) {
                ...
                telemetry.addLine("OutField, Blue - left");
                telemetry.update();
            } else if (spikeNum == 2) {
                moveLin( 29);
                moveLin( -10);
                ...
                telemetry.addLine("OutField, Blue - middle");
                telemetry.update();
            } else { //right
                moveLat(12);
                moveLin( 20);
                ...
                telemetry.addLine("OutField, Blue - right");
                telemetry.update();
            }
        } else {
            if (spikeNum == 1) {
                ...
                telemetry.addLine("Infield, Blue - left");
                telemetry.update();
            } else if (spikeNum == 2) {
                moveLin( 28);
                moveLin( -22);
                ...
                telemetry.addLine("Infield, Blue - middle");
                telemetry.update();
            } else { //right
                moveLat(-12);
                moveLin( 26);
                ...
                telemetry.addLine("Infield, Blue - right");
                telemetry.update();
            }
        }
    ...
    public void moveAngTest(double degrees) {
        ...
        while (Math.abs(ANG_TRGT - angInt) > 2) {
            ...
            */
            angDel = (((angNow - angOld) < -180) ? (angNow - angOld)+360
                    : ((angNow - angOld) >= 180) ? (angNow - angOld)-360
                    : (angNow - angOld));
            angInt += angDel;
            angOld = angNow;
