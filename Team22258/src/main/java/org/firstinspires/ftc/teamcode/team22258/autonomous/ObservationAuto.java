package org.firstinspires.ftc.teamcode.team22258.autonomous;
...
@Autonomous(name = "Observation", group="autonomous")
public class ObservationAuto extends LinearOpMode {
     ...
     * Describe this function...
     */
    private void Clawrm(int iArm, int iWrist_b, int iClaw_b) {
        Arm2((int) iArm);
        Wristoggle(iWrist_b);
        Clawggle(iClaw_b);
    }
